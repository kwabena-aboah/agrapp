...
class Page(models.Model):
    ...
    tags = models.CharField(max_length=255, null=True,
                            blank=True, help_text='Tags for the published article')
...
class Link(models.Model):
    ...
    group = models.CharField(
        max_length=100, help_text='Group text under which links will be compiled for display.')
    url = models.CharField(max_length=500, blank=True, null=True,
                           help_text='Url of resource this link points to.')
    page = models.ForeignKey(Page, blank=True, null=True,
                             help_text='Page resource this link points to.')
    updated_by = models.CharField(max_length=100)
