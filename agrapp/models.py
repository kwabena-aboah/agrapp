...
class SysConfig(models.Model):
    ...
    def get_config(cls, name):
        ...
        raise ImproperlyConfigured(
            '"%s" is not found, it should be defined in System Configs' % name)
    ...
    def get_configs(cls):
        ...
        if not hasattr(cls, 'sys_configs'):
            cls.sys_configs = dict((sys_config.name, sys_config.value)
                                   for sys_config in cls.objects.all())
