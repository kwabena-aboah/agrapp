...
class BaseView(TemplateView):
    """
    Base view for all agrapp views
    ...
    base_template_name = 'agrapp/base.html'
    ...
    def get_decorators(cls):
        ...
        Generic base views should override get_decorators method 

        instead of defining decorators attribute
        """
