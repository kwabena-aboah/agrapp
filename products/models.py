...
class Manufacturer(models.Model):
    ...
    def get_absolute_url(self):
        return ('products_manufacturer', (self.slug,))
...
class Category(models.Model):
    ...
    pic = models.ImageField(
        upload_to='images/products/categories', null=True, blank=True)
    parent = models.ForeignKey(
        'self', related_name='sub_categories', null=True, blank=True)
    tags = models.CharField(max_length=100, null=True, blank=True,
                            help_text='Comma-delimited set of SEO keywords for meta tag')
    display_order = models.IntegerField(default=0)
    is_active = models.BooleanField(default=True)
    is_expended = models.BooleanField(
        default=False, help_text='Catergory will always shown expended')
    updated_by = models.CharField(max_length=100)
    updated_on = models.DateTimeField(auto_now=True)
    created_on = models.DateTimeField(auto_now_add=True)
    created_by = models.CharField(max_length=100)
    ...
    @models.permalink
    def get_absolute_url(self):
        return ('products_category', (self.slug,))
...
class Product(models.Model):
    ...
    @models.permalink
    def get_absolute_url(self):
        return ('products_product', (self.id, self.slug,),)
