...
from agrapp.admin import ModelAdmin
...
class ProductAdmin(ModelAdmin):
    ...
    list_filter = ('brand', 'is_active', 'is_bestseller',
                   'is_featured', 'is_free_shipping', 'created_on',)
    search_fields = ('name', 'gist', 'brand__name',
                     'sku', 'gtin', 'part_number',)
    prepopulated_fields = {'slug': ('name',)}
    date_hierarchy = 'created_on'
