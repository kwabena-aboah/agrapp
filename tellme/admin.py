...
class FeedbackAdmin(admin.ModelAdmin):
    list_display = ("comment", "url", "screenshot_thumb",
                    "user", "email", "created", "ack")
    list_filter = ("created", "ack", "user", "url")
    search_fields = ("comment", "user__email", "user__name")
    readonly_fields = ("comment", "url", "user",
                       "browser_html", "screenshot_thumb")
    ...
    browser_html.short_description = pgettext_lazy(
        "Admin model", "Browser Info")
