...
from .models import Gateway, Transaction, TransactionParam
from .processors import PayPal, Stripe
    ...
    if request.method == "POST":
        ...
        try:
            if gateway.name == Gateway.PAYPAL:
                ...
                raise ImproperlyConfigured('Agrapp doesn\'t yet support payment with %s account.'
...
class ProcessingMessageView(ProductsBaseView):
    """
