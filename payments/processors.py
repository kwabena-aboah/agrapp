...
from .models import GatewayParam, Transaction
...
class PayPal:
    ...
    def create_account_payment(self, order, user):
        ...
        try:
            ...
            raise AgrappError('We failed to process your PayPal account at the moment, please try again later!')
    ...
    def credit_card_payment(self, card, order, user):
        ...
        try:
            ...
            raise AgrappError('We failed to process your Credit Card at the moment, please try again later!')
...
class Stripe:
    ...
    def credit_card_payment(self, card, order, user):
        ...
        try:
            ...
            raise AgrappError(error['message'])
        except Exception as e:
            logger.error('Failed to process Credit Card (transaction_id: %s)' % payment_txn.id)
            logger.exception(e)
