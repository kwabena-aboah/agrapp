...
from .views import LoginView, LogoutView, RegisterView, ForgotPasswordView, PasswordResetView, ChangePasswordView
...
urlpatterns = [
    ...
    url(r'^forgot_password/$', ForgotPasswordView.as_view(),
